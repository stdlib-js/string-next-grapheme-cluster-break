...
```javascript
import nextGraphemeClusterBreak from 'https://cdn.jsdelivr.net/gh/stdlib-js/string-next-grapheme-cluster-break@v0.2.3-esm/index.mjs';
```
...
[@stdlib/string/prev-grapheme-cluster-break]: https://github.com/stdlib-js/string-prev-grapheme-cluster-break/tree/esm
